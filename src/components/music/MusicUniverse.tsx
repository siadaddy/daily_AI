    ...
    >
      ...
      {loaded && (
        <button
          ...
          className="absolute bottom-4 right-4 z-20 flex items-center gap-1.5 rounded-lg px-3 py-1.5 text-xs font-medium backdrop-blur-sm transition-all hover:scale-105"
          style={{
